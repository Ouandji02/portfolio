...
export default function Nav() {
  ...
  return (
    <nav className="bg-white py-3 px-20 dark:text-gray-700 dark:bg-dark flex justify-between flex-wrap max-md:px-5 fixed w-full z-[5] items-center">
      ...
      <div className="flex justify-end items-center space-x-2 mx-auto relative dark:text-white">
        <span className="text-xs font-extralight text-gray-600">Light </span>

        <label className="inline-flex relative items-center cursor-pointer">
          <input type="checkbox" id="checkbox" value="" className="sr-only peer" />
          <div className="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4  dark:peer-focus:ring-dark rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-gray-700"></div>
        </label>
